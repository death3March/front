...
export class ServerMessage extends pb_1.Message {
    ...
    get type() {
        const cases: {
            [index: number]: "none" | "playerTurnStart" | "sugorokuMoveUpdate" | "playerMovementDisplay" | "quizStart" | "quizResult" | "otoshidamaEvent" | "rankingUpdate" | "gameStart" | "gameEnd";
        } = {
            0: "none",
            1: "playerTurnStart",
    ...
    serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
        ...
        if (this.has_quizStart)
            writer.writeMessage(4, this.quizStart, () => this.quizStart.serialize(writer));
        if (this.has_quizResult)
            writer.writeMessage(5, this.quizResult, () => this.quizResult.serialize(writer));
        if (this.has_otoshidamaEvent)
            writer.writeMessage(6, this.otoshidamaEvent, () => this.otoshidamaEvent.serialize(writer));
        if (this.has_rankingUpdate)
            writer.writeMessage(7, this.rankingUpdate, () => this.rankingUpdate.serialize(writer));
        if (this.has_gameStart)
            writer.writeMessage(8, this.gameStart, () => this.gameStart.serialize(writer));
        if (this.has_gameEnd)
            writer.writeMessage(9, this.gameEnd, () => this.gameEnd.serialize(writer));
        if (!w)
    ...
    static deserialize(bytes: Uint8Array | pb_1.BinaryReader): ServerMessage {
        ...
        while (reader.nextField()) {
            ...
            switch (reader.getFieldNumber()) {
                case 1:
                    reader.readMessage(message.playerTurnStart, () => message.playerTurnStart = PlayerTurnStart.deserialize(reader));
                    break;
                case 2:
                    reader.readMessage(message.sugorokuMoveUpdate, () => message.sugorokuMoveUpdate = SugorokuMoveUpdate.deserialize(reader));
                    break;
                case 3:
                    reader.readMessage(message.playerMovementDisplay, () => message.playerMovementDisplay = PlayerMovementDisplay.deserialize(reader));
                    break;
                case 4:
                ...
                case 5:
                    ...
                    break;
                case 6:
                    reader.readMessage(message.otoshidamaEvent, () => message.otoshidamaEvent = OtoshidamaEvent.deserialize(reader));
                    break;
                case 7:
...
export class PlayerTurnStart extends pb_1.Message {
    ...
    static deserialize(bytes: Uint8Array | pb_1.BinaryReader): PlayerTurnStart {
        const reader = bytes instanceof pb_1.BinaryReader ? bytes : new pb_1.BinaryReader(bytes), message = new PlayerTurnStart();
        while (reader.nextField()) {
            if (reader.isEndGroup())
                break;
            switch (reader.getFieldNumber()) {
...
export class SugorokuMoveUpdate extends pb_1.Message {
    ...
    static deserialize(bytes: Uint8Array | pb_1.BinaryReader): SugorokuMoveUpdate {
        const reader = bytes instanceof pb_1.BinaryReader ? bytes : new pb_1.BinaryReader(bytes), message = new SugorokuMoveUpdate();
        while (reader.nextField()) {
            if (reader.isEndGroup())
                break;
            switch (reader.getFieldNumber()) {
    ...
    export class Data extends pb_1.Message {
        ...
        serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
            ...
            if (this.stepsMoved != 0)
                writer.writeInt32(2, this.stepsMoved);
            if (this.newPosition != 0)
                writer.writeInt32(3, this.newPosition);
            if (!w)
                return writer.getResultBuffer();
        }
        static deserialize(bytes: Uint8Array | pb_1.BinaryReader): Data {
...
export class PlayerMovementDisplay extends pb_1.Message {
    ...
    static deserialize(bytes: Uint8Array | pb_1.BinaryReader): PlayerMovementDisplay {
        const reader = bytes instanceof pb_1.BinaryReader ? bytes : new pb_1.BinaryReader(bytes), message = new PlayerMovementDisplay();
        while (reader.nextField()) {
            if (reader.isEndGroup())
                break;
            switch (reader.getFieldNumber()) {
    ...
    export class Data extends pb_1.Message {
        ...
        serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
            ...
            if (this.playerId != 0)
                writer.writeInt32(1, this.playerId);
            if (this.newPosition != 0)
                writer.writeInt32(2, this.newPosition);
            if (!w)
                return writer.getResultBuffer();
        }
        static deserialize(bytes: Uint8Array | pb_1.BinaryReader): Data {
...
export class QuizStart extends pb_1.Message {
    ...
    static deserialize(bytes: Uint8Array | pb_1.BinaryReader): QuizStart {
        const reader = bytes instanceof pb_1.BinaryReader ? bytes : new pb_1.BinaryReader(bytes), message = new QuizStart();
        while (reader.nextField()) {
            if (reader.isEndGroup())
                break;
            switch (reader.getFieldNumber()) {
...
export namespace QuizStart {
    export class Data extends pb_1.Message {
        ...
        serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
            ...
            if (this.playerId != 0)
                writer.writeInt32(1, this.playerId);
            if (this.quizQuestion.length)
                writer.writeString(2, this.quizQuestion);
...
export class QuizResult extends pb_1.Message {
    ...
    static deserialize(bytes: Uint8Array | pb_1.BinaryReader): QuizResult {
        const reader = bytes instanceof pb_1.BinaryReader ? bytes : new pb_1.BinaryReader(bytes), message = new QuizResult();
        while (reader.nextField()) {
            if (reader.isEndGroup())
                break;
            switch (reader.getFieldNumber()) {
...
export namespace QuizResult {
    export class Data extends pb_1.Message {
        ...
        serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
            const writer = w || new pb_1.BinaryWriter();
            if (this.correctPlayerId != 0)
                writer.writeInt32(1, this.correctPlayerId);
            if (this.otoshidamaAmount != 0)
                writer.writeInt32(2, this.otoshidamaAmount);
...
export class OtoshidamaEvent extends pb_1.Message {
    ...
    static deserialize(bytes: Uint8Array | pb_1.BinaryReader): OtoshidamaEvent {
        const reader = bytes instanceof pb_1.BinaryReader ? bytes : new pb_1.BinaryReader(bytes), message = new OtoshidamaEvent();
        while (reader.nextField()) {
            if (reader.isEndGroup())
                break;
            switch (reader.getFieldNumber()) {
    ...
    export class Data extends pb_1.Message {
        ...
        serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
            ...
            if (this.playerIds.length)
                writer.writePackedInt32(1, this.playerIds);
            if (this.has_map)
        ...
        export class Map extends pb_1.Message {
            ...
            serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
                ...
                if (this.squares.length)
                    writer.writePackedEnum(1, this.squares);
                if (!w)
                    return writer.getResultBuffer();
            }
...
export class RankingUpdate extends pb_1.Message {
    ...
    static deserialize(bytes: Uint8Array | pb_1.BinaryReader): RankingUpdate {
        const reader = bytes instanceof pb_1.BinaryReader ? bytes : new pb_1.BinaryReader(bytes), message = new RankingUpdate();
        while (reader.nextField()) {
            if (reader.isEndGroup())
                break;
            switch (reader.getFieldNumber()) {
    ...
    export class Data extends pb_1.Message {
        ...
        static deserialize(bytes: Uint8Array | pb_1.BinaryReader): Data {
            ...
            while (reader.nextField()) {
                ...
                switch (reader.getFieldNumber()) {
                    case 1:
                        reader.readMessage(message.rankings, () => pb_1.Message.addToRepeatedWrapperField(message, 1, RankingUpdate.Data.Ranking.deserialize(reader), RankingUpdate.Data.Ranking));
                        break;
                    default: reader.skipField();
                }
            }
    ...
    export namespace Data {
        export class Ranking extends pb_1.Message {
            ...
            static deserialize(bytes: Uint8Array | pb_1.BinaryReader): Ranking {
                const reader = bytes instanceof pb_1.BinaryReader ? bytes : new pb_1.BinaryReader(bytes), message = new Ranking();
                while (reader.nextField()) {
                    if (reader.isEndGroup())
                        break;
                    switch (reader.getFieldNumber()) {
