...
export class Data extends pb_1.Message {
	#one_of_decls: number[][] = [[1, 2, 3, 4, 5, 7]];
	constructor(
		data?:
			| never[]
			| ({
	...
	get type() {
		const cases: {
			[index: number]: "none" | "roomName" | "point" | "DisplayName" | "message" | "newUserID" | "event";
		} = {
			0: "none",
			1: "roomName",
			2: "point",
		...
		return cases[pb_1.Message.computeOneofCase(this, [1, 2, 3, 4, 5, 7])];
	}
	...
	serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
		...
		if (this.has_event) writer.writeString(7, this.event);
