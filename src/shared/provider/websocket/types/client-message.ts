...
export class ClientMessage extends pb_1.Message {
    ...
    get type() {
        const cases: {
            [index: number]: "none" | "roomJoinRequest" | "roomLeaveRequest" | "gameStartRequest" | "gameEndRequest" | "quizAnswer" | "turnEndNotification" | "otherMessage";
        } = {
            0: "none",
            1: "roomJoinRequest",
            2: "roomLeaveRequest",
    ...
    serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
        ...
        if (this.has_quizAnswer)
            writer.writeMessage(5, this.quizAnswer, () => this.quizAnswer.serialize(writer));
        if (this.has_turnEndNotification)
            writer.writeMessage(6, this.turnEndNotification, () => this.turnEndNotification.serialize(writer));
        if (this.has_otherMessage)
            writer.writeMessage(7, this.otherMessage, () => this.otherMessage.serialize(writer));
        if (!w)
    ...
    static deserialize(bytes: Uint8Array | pb_1.BinaryReader): ClientMessage {
        ...
        while (reader.nextField()) {
            ...
            switch (reader.getFieldNumber()) {
                case 1:
                    reader.readMessage(message.roomJoinRequest, () => message.roomJoinRequest = RoomJoinRequest.deserialize(reader));
                    break;
                case 2:
                    reader.readMessage(message.roomLeaveRequest, () => message.roomLeaveRequest = RoomLeaveRequest.deserialize(reader));
                    break;
                case 3:
                    reader.readMessage(message.gameStartRequest, () => message.gameStartRequest = GameStartRequest.deserialize(reader));
                    break;
                case 4:
                    reader.readMessage(message.gameEndRequest, () => message.gameEndRequest = GameEndRequest.deserialize(reader));
                    break;
                case 5:
                    reader.readMessage(message.quizAnswer, () => message.quizAnswer = QuizAnswer.deserialize(reader));
                    break;
                case 6:
                    reader.readMessage(message.turnEndNotification, () => message.turnEndNotification = TurnEndNotification.deserialize(reader));
                    break;
                case 7:
...
export class RoomJoinRequest extends pb_1.Message {
    ...
    static deserialize(bytes: Uint8Array | pb_1.BinaryReader): RoomJoinRequest {
        const reader = bytes instanceof pb_1.BinaryReader ? bytes : new pb_1.BinaryReader(bytes), message = new RoomJoinRequest();
        while (reader.nextField()) {
            if (reader.isEndGroup())
                break;
            switch (reader.getFieldNumber()) {
...
export namespace RoomJoinRequest {
    export class Data extends pb_1.Message {
        ...
        serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
            ...
            if (this.roomCode.length)
                writer.writeString(2, this.roomCode);
            if (!w)
                return writer.getResultBuffer();
        }
...
export class RoomLeaveRequest extends pb_1.Message {
    ...
    static deserialize(bytes: Uint8Array | pb_1.BinaryReader): RoomLeaveRequest {
        const reader = bytes instanceof pb_1.BinaryReader ? bytes : new pb_1.BinaryReader(bytes), message = new RoomLeaveRequest();
        while (reader.nextField()) {
            if (reader.isEndGroup())
                break;
            switch (reader.getFieldNumber()) {
...
export class GameStartRequest extends pb_1.Message {
    ...
    static deserialize(bytes: Uint8Array | pb_1.BinaryReader): GameStartRequest {
        const reader = bytes instanceof pb_1.BinaryReader ? bytes : new pb_1.BinaryReader(bytes), message = new GameStartRequest();
        while (reader.nextField()) {
            if (reader.isEndGroup())
                break;
            switch (reader.getFieldNumber()) {
...
export class GameEndRequest extends pb_1.Message {
    ...
    static deserialize(bytes: Uint8Array | pb_1.BinaryReader): GameEndRequest {
        const reader = bytes instanceof pb_1.BinaryReader ? bytes : new pb_1.BinaryReader(bytes), message = new GameEndRequest();
        while (reader.nextField()) {
            if (reader.isEndGroup())
                break;
            switch (reader.getFieldNumber()) {
...
export class QuizAnswer extends pb_1.Message {
    ...
    static deserialize(bytes: Uint8Array | pb_1.BinaryReader): QuizAnswer {
        const reader = bytes instanceof pb_1.BinaryReader ? bytes : new pb_1.BinaryReader(bytes), message = new QuizAnswer();
        while (reader.nextField()) {
            if (reader.isEndGroup())
                break;
            switch (reader.getFieldNumber()) {
...
export class TurnEndNotification extends pb_1.Message {
    ...
    static deserialize(bytes: Uint8Array | pb_1.BinaryReader): TurnEndNotification {
        const reader = bytes instanceof pb_1.BinaryReader ? bytes : new pb_1.BinaryReader(bytes), message = new TurnEndNotification();
        while (reader.nextField()) {
            if (reader.isEndGroup())
                break;
            switch (reader.getFieldNumber()) {
...
export class OtherMessage extends pb_1.Message {
    ...
    static deserialize(bytes: Uint8Array | pb_1.BinaryReader): OtherMessage {
        const reader = bytes instanceof pb_1.BinaryReader ? bytes : new pb_1.BinaryReader(bytes), message = new OtherMessage();
        while (reader.nextField()) {
            if (reader.isEndGroup())
                break;
            switch (reader.getFieldNumber()) {
